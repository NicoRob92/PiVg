...
export default function SearchBar(){
    ...
    return(
        <Conteiner>            
            <Form  onSubmit ={(e) => {e.preventDefault();dispatch(getAGame(name));setname('')} } autocomplete="off">
            <Input type="text" name="name" placeholder="ingrese juego"  value={name} onChange={(e)=> setname(e.target.value)}></Input>
            <NavLink to='/home'><Button type="submit"><span>Buscar</span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 74 74" height="34" width="34">
